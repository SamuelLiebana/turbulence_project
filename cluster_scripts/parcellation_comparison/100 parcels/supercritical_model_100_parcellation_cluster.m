function supercritical_model_100_parcellation_cluster(s)

%load('HCP100_empirical_1003_subs.mat') 
...
save(sprintf('matrix_values_supercrit_100_beta_%03d.mat',s), 'Rspatime_av_sim', 'mean_global_av_sim', 'std_global_av_sim', 'edge_matrix_std_av_sim', 'EdgeSpaTimePredictability_av_sim');

%save(sprintf('abs_errors_supercrit_100_beta_%03d.mat',s), 'Rspatime_diff', 'mean_global_diff', 'std_global_diff', 'edge_matrix_std_diff', 'EdgeSpaTimePredictability_diff');
