...
G_range=0:0.025:0.5;
beta_range = 1:0.1:3; % loop over different beta values 1-3 and optimise
...
h = heatmap(beta_range,G_range,Rspatime_diff);
...
h = heatmap(beta_range,G_range,mean_global_diff);
...
h = heatmap(beta_range,G_range,std_global_diff);
...
h = heatmap(beta_range,G_range,edge_matrix_std_diff);
